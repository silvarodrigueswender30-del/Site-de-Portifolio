...
const CONFIG = {
  ...
  description:
    "Integramos as tecnologias mais avançadas do mercado global para criar uma experiência digital rápida, segura e imersiva.",
...
const MagnifiedBento = () => {
  ...
  return (
    <div className="flex items-center justify-center p-4 sm:p-6 w-full not-prose" style={{ background: 'linear-gradient(180deg, #0D1F3C 0%, #081629 50%, #060E1C 100%)' }}>
      <div className="group relative w-full max-w-[420px] overflow-hidden rounded-[2rem] sm:rounded-[2.5rem] border border-white/10 bg-white p-1.5 sm:p-2 shadow-2xl shadow-primary/5 transition-all duration-500 hover:shadow-primary/10 hover:-translate-y-1">
        <div
          ref={containerRef}
          className={cn(
        ...
        <div className="p-4 sm:p-6 px-4 pb-6 sm:pb-8">
          <h3 className="text-xl font-medium tracking-tight text-[#0D1F3C]">
            {CONFIG.title}
          </h3>
