...
class App {
  ...
  createMedias(
    ...
    // Imagens padrão com temática de automação industrial / Master Data
...
const CircularGallery = ({
  ...
  useEffect(() => {
    ...
    const computedFontWeight = computedStyle.fontWeight || "400";
  ...
  return (
    <div
      ref={containerRef}
      className={`w-full h-full overflow-hidden cursor-grab active:cursor-grabbing text-white font-normal text-[28px] ${className ?? ""}`}
      {...props}
    />
  );
};
